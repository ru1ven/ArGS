...
class Config:
    setting = "dexycb"  # ho3d, ho3d_render, dexycb, dexycb_full
    # ~~~~~~~~~~~~~~~~~~~~~~Dataset~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    if "ho3d" in setting:
        dataset = "ho3d"
    else:
    ...
    object_models_dir = "./dataset/DexYCB/models/"
    output_dir = "outputs"

    annotation_dir = "./dataset/DexYCB/annotation/"
    simple_object_models_dir = "./dataset/DexYCB/simple_models/"
    if dataset == "ho3d":
        ho3d_data_dir = None
        fast_data_dir = None
    elif dataset == "dexycb":
        dexycb_data_dir = "./dataset/DexYCB/data"
        dexycb_model_dir = "./dataset/DexYCB"
        fast_data_dir = None
