...
class ObjectTensors(nn.Module):
    def __init__(self, device='cpu'):
        ...
        self.obj_tensors = thing.thing2dev(construct_obj_tensors(OBJECTS), device)
        self.dev = None
...
def construct_obj(object_model_p):
    ...
    top_sub_p = f"/mnt/sda2/lxy/dataset/hand/arctic/meta/object_vtemplates/{obj_name}/top_keypoints_300.json"
    ...
    with open("/mnt/sda2/lxy/dataset/hand/arctic/meta/object_meta.json", "r") as f:
...
def construct_obj_tensors(object_names):
    ...
    for k in object_names:
        object_model_p = f"/mnt/sda2/lxy/dataset/hand/arctic/meta/object_vtemplates/%s" % (k)
